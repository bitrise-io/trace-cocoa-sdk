...
internal enum Constants {
    ...
    internal enum SDK: String {
        ...
        case name = "Trace"
        case version = "1.6.0" // Static library does not include a .plist with details about package. Would be nice to automate this the version details on this class
    }
